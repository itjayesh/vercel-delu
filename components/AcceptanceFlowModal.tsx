      ...
      <div className="flex flex-col items-center space-y-2">
        <CameraCapture
          ...
          trigger={
            <button
              type="button"
              className="w-full h-64 rounded-lg bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-gray-700 transition-colors"
            >
  ...
  const ConfirmStage = () => (
    <div className="space-y-4 text-white text-center">
      <img
        ...
        alt="Selfie Preview"
        className="w-48 h-48 rounded-lg object-cover mx-auto mb-4 border-2 border-blue-500"
      />
      <div className="bg-yellow-500/10 border border-yellow-500/30 text-yellow-300 p-4 rounded-lg text-sm">
        ...
        <p className="mt-2">
          Once accepted, this gig must be delivered on time. You are solely responsible for the safe and timely delivery
          of the parcel. Cancellations are not permitted after this step.
        </p>
        {gig.isUrgent && (
