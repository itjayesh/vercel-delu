...
export const IdIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const AngularIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="m12 3-9 3 2 15.5L12 23l7-1.5L21 6l-9-3z" />
    <path d="m12 11-2.5 5h5L12 11z" />
    <path d="M12 11V6.5" />
    <path d="m9.5 16-1-3" />
    <path d="m14.5 16 1-3" />
  </svg>
...
export const JavaScriptIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M7 7v5s0 2 2 2 2-1 2-1" />
    <path d="M14 7v7.5c0 1 0 2.5-2.5 2.5S9 16.5 9 15.5" />
...
export const NextjsIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M9 15V9l7-7 7 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2h8a2 2 0 0 1-2 2V8a2 2 0 0 1-2-2h-8z" />
    <path d="M15 12V9" />
  </svg>
)

export const NuxtIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    ...
    {...props}
  >
    <path d="M12.07 2H2.06a1 1 0 0 0-.86 1.5l10 17a1 1 0 0 1 1.72 0l10-17A1 1 0 0 0 22.06 2Z" />
    <path d="M7.07 12h10" />
  </svg>
)

export const ReactFrameworkIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    ...
    {...props}
  >
    <circle cx="12" cy="11.9" r="2.1" />
    <path d="M17.7 7.7a2.5 2.5 0 1 1 0-1.4" />
    <path d="M18.7 17.6a2.5 2.5 0 1 0 0-1.4" />
    <path d="M5.3 17.6a2.5 2.5 0 1 0 0-1.4" />
    <path d="M6.3 7.7a2.5 2.5 0 1 1 0-1.4" />
    <path d="M12 4.7a19.2 19.2 0 0 0-4 7.8 19.2 19.2 0 0 0 8 0 19.2 19.2 0 0 0-4-7.8Z" />
    <path d="M12 19.3a19.2 19.2 0 0 1-8 0 19.2 19.2 0 0 1 4-7.8 19.2 19.2 0 0 1 8 0 19.2 19.2 0 0 1-4 7.8Z" />
  </svg>
)

export const SvelteIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    ...
    {...props}
  >
    <path d="M5 11s2-1.5 4-1.5c1.5 0 3 1 3.5 3s2.5 3 4 3c2 0 3.5-1.5 3.5-1.5" />
    <path d="M8 19.5c-1.5 0-3-1-3.5-3s-2.5-3-4-3C2 13.5.5 15 .5 15" />
    <path d="M10.5 5.5c1.5 0 3 1 3.5 3s2.5 3 4 3c2 0 3.5-1.5 3.5-1.5" />
  </svg>
)
...
export const VueIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M18 3 6 3 12 12 18 3z" />
    <path d="m15 3 3 0L12 12 6 3 9 3" />
    <path d="M12 12 4.5 21h15L12 12z" />
  </svg>
)
...
export const BriefcaseIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M21 13l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"
    />
  </svg>
)
